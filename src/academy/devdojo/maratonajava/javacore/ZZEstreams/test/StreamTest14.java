...
public class StreamTest14 {
    ...
    public static void main(String[] args) {
        Map<Promotion, List<LigthoNovel>> collect = ligthoNovels
                .stream()
                .collect(Collectors.groupingBy(ln -> ln.getPrice() < 6 ? Promotion.UNDER_PROMOTION : Promotion.NORMAL_PRICE
                ));
        System.out.println(collect);

        Map<Category, Map<Promotion, List<LigthoNovel>>> collect1 = ligthoNovels.stream().collect(Collectors.groupingBy(LigthoNovel::getCategory,
