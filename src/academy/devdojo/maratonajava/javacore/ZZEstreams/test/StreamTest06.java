...
public class StreamTest06 {
    ...
    public static void main(String[] args) {
        System.out.println(ligthoNovels.stream().anyMatch(ln -> ln.getPrice() > 8));
        System.out.println(ligthoNovels.stream().anyMatch(ln -> ln.getPrice() > 0));
        System.out.println(ligthoNovels.stream().noneMatch(ln -> ln.getPrice() > 0));
